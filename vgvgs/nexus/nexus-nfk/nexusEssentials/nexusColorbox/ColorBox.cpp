...
using namespace NSLIB_COLORBOX;
...
//    this->setColor ( color );
//  }
  // NSLIB_COLORPICKER::ColorPickerDialog ( this->m_color, this, tr ( "Select color" ) );
  NSLIB_COLORPICKER::ColorPickerDialog colorPickerDialog ( this, this->m_color );
