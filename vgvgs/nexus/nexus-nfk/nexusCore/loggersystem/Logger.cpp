...
Logger::Logger () {
  ...
  this->filePath = AppPaths::getInstance ()->getApplicationLogPath () + AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "app/applicationname" ).toString () + "_error.log";
  this->init ();
}
...
void Logger::checkAndRotateLog () {
  ...
  if ( this->logFile.data ()->size () >= MAX_LOG_SIZE ) {
    ...
    QString newFileName = AppPaths::getInstance ()->getApplicationLogPath () + fileInfo.baseName () + "_" + currentDateTime.toString ( "yyyy-MM-dd hh:mm:ss" ) + ".log";
...
void Logger::exception ( const Exception &exception ) {
...
//  EmailAddress sender (
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/sender" ).toString (),
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/sendername" ).toString () );
//  mimeMessage.setSender ( sender );

//  EmailAddress to (
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/addressee" ).toString (),
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/addresseename" ).toString () );
//  mimeMessage.addRecipient ( to );

//  mimeMessage.setSubject ( AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/subject" ).toString () );
...
//  SmtpClient smtp (
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/smtpserver" ).toString (),
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/port" ).toInt (),
...
//  smtp.login (
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/user" ).toString (),
//    AppManager::getInstance ()->getAppConfig ()->getSettings ()->value ( "logger/password" ).toString () );
