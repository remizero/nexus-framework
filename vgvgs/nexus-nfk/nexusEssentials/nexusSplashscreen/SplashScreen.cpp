...
using namespace NSLIB_SPLASHSCREEN;


SplashScreen::SplashScreen ( QSettings *settings ) {

  this->textColor = QColor ( "#" + settings->value ( "splashscreen/font/color" ).toString () );
  QSplashScreen::setPixmap ( QPixmap ( NSLIB_CORE::AppPaths::getInstance ()->getApplicationImagePath () + settings->value ( "splashscreen/imagesplash" ).toString () ) );
