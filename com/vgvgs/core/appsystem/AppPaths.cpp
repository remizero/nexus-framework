...
void AppPaths::initialize () {
  ...
  // TODO Crear un first run para configurar los valores que sean necesarios de parte del usuario.
  // TODO Guardar como recurso un archivo XML, INI y JSON del archivo config para ser guardado
  //      a nivel de usuario. Establecer tambien la ruta que ha de tener.
