...
void MainWindow::createSysTrayIcon () {
  ...
  if ( QSystemTrayIcon::isSystemTrayAvailable () ) {
    ...
    if ( NSLIB_CORE::AppInit::getInstance ()->getAppConfig ()->getSettings ()->value ( "systemtrayicon/showsystemtrayicon" ).toBool () ) {

      this->sysTrayIcon = new NSLIB_SYSTEMTRAYICON::SystemTrayIcon ( this );
...
void MainWindow::iconActivated ( QSystemTrayIcon::ActivationReason reason ) {
  ...
  switch ( reason ) {
    ...
    case QSystemTrayIcon::Trigger:
      ...
      if ( NSLIB_CORE::AppInit::getInstance ()->getAppConfig ()->getSettings ()->value ( "app/showsystemtrayicon" ).toBool () ) {
...
void MainWindow::init ( QSettings *settings ) {
  ...
  this->setWindowIcon ( QIcon ( NSLIB_CORE::AppPaths::getInstance ()->getApplicationImagePath () + settings->value ( "app/iconimage" ).toString () ) );
